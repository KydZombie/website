...
const [backEl, showEl, hideEl, nextEl, moreEl, lessEl] = document.querySelectorAll('#cardbuttons button');
...
const [addEl, removeEl, saveEl, loadEl, clearEl, wipeEl] = document.querySelectorAll('#databuttons button');
